...
class TextIterator:
    ...
    def __next__(self):
        ...
        '''
        np_source_raw = np_source_raw.decode('UTF-8')
        np_source_d1_raw = np_source_d1_raw.decode('UTF-8')
        np_source_d2_raw = np_source_d2_raw.decode('UTF-8')
        '''
        ...
        return source, source_d1, source_d2, label, numpy.array(
            tech_final), max_word_len
        #np_source_raw, np_source_d1_raw, np_source_d2_raw
        # source_len, source_d1_len, source_d2_len,
        # np_source_elmo.astype('int64'), np_source_d1_elmo.astype('int64'), np_source_d2_elmo.astype('int64')
...
def main():
    ...
    for i, (x, xd1, xd2, y, tech, a, b, c, d, e, f, g, h, i) in enumerate(train):
        ...
        print(len(a), len(b), len(c), d.shape, e.shape, f.shape, g.shape, h.shape, i.shape)
