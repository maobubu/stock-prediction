...
def main():
    train = TextIterator('/Users/maobu/Dropbox/stock/data/ding/train.csv',
                         '/Users/maobu/Dropbox/stock/data/ding/train_label.csv',
                         dict='/Users/maobu/Dropbox/stock/data/ding/vocab_cased_title.pickle',
                         delay1=3,
                         delay2=7,
                         types='article',
                         n_words=43920,
                         batch_size=128, cut_word=False, cut_news=False,
                         shuffle=True)  # cut word: max length of the words in sentence
    validate = TextIterator('/Users/maobu/Dropbox/stock/data/ding/validate.csv',
                            '/Users/maobu/Dropbox/stock/data/ding/validate_label.csv',
                            dict='/Users/maobu/Dropbox/stock/data/ding/vocab_cased_title.pickle',
                            delay1=3,
                            delay2=7,
                            types='article',
                            ...
                            batch_size=128, cut_word=False, cut_news=False,
                            shuffle=True)  # cut word: max length of the words in sentence
    test = TextIterator('/Users/maobu/Dropbox/stock/data/ding/validate.csv',
                        '/Users/maobu/Dropbox/stock/data/ding/validate_label.csv',
                        dict='/Users/maobu/Dropbox/stock/data/ding/vocab_cased_title.pickle',
                        delay1=3,
                        delay2=7,
