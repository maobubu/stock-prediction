...
def days(emb, sequence_mask, sentence_mask, news_mask, keep_prob, is_training, options):
    ...
    word_level_output = attention_v2(word_encoder_out, word_level_mask, name='word_attention', keep=keep_prob, r=5,
    ...
    sentence_level_output = attention_v2(sentence_encoder_out, sentence_level_mask, name='sentence_attention',
                                         keep=keep_prob,
                                         is_training=is_training)
    ...
    news_level_output = attention_v2(news_level_input, news_level_mask, name='news_attention', keep=keep_prob,
...
def news(emb, sequence_mask, sentence_mask, news_mask, keep_prob, is_training, options):
    ...
    ##TODO news level attention
    news_level_output = attention_v2(news_level_input, news_mask, name='news_attention', keep=keep_prob,
